...
class LandingPage3 : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        ivKirim.setOnClickListener {
            ...
            val intentLandingTiga = Intent(activity,HalamanMenu::class.java)
            val bundle= Bundle()

            bundle.putString("name",etNama.text.toString())
            intentLandingTiga.putExtras(bundle)
            startActivity(intentLandingTiga)
        }
